...
namespace Sahara.Core.Platform.Initialization.Sql.Scripts.PlatformDB.Initialization
{
    internal class Initialization
    {
        ...
        /// <returns></returns>
        public bool InitializePlatformDB(ReliableSqlConnection sqlConnection)
        {
            ...
            {
                foreach (var sqlScript in resourceNames.Where(o => o.StartsWith(assemblyName + ".Sql.Scripts.PlatformDB.Initialization." + folder)))
                {
