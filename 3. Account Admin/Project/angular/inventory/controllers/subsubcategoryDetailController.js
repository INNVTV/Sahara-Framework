(function () {
    ...
    var controllerId = 'subsubcategoryDetailController';
    ...
    angular.module('app')
        .controller(controllerId, [
            ...
            'searchServices',
            '$routeParams',
             subsubcategoryDetailController
    ]);

    function subsubcategoryDetailController(categoryServices, categoryModels, sharedServices, productServices, accountServices, imageServices, searchServices, $routeParams) {

        //Instantiate Controller as ViewModel
        var vm = this;

        //Default Properties: =============================
        vm.title = 'subsubcategoryDetailController';
        ...
        $(window).scroll(function () {
            if ($(window).scrollTop() + $(window).height() == $(document).height()) {
                ...
                if (vm.amountToSkip < vm.resultsAvailable && vm.products != null && vm.searchingMore == false) {
                    ...
                    var locationPath = vm.subsubcategory.FullyQualifiedName;
       ...
       ==========================================*/
        ...
        vm.SubsubcategoryNameStatus =
            {
                ...
                Clear: function () {
                    ...
                    //Debug.trace("Clearing update subsubcategory name form data.");
                    this.Updating = false;
                    this.Editing = false;
                    this.SendingComplete = false;
                }
        ...
        vm.editSubsubcategoryName = function () {
            //Debug.trace("Editing subsubcategory name...");

            vm.SubsubcategoryNameStatus.NewSubsubcategoryName = vm.subsubcategory.SubsubcategoryName;

            vm.SubsubcategoryNameStatus.Editing = true;

        }

        vm.cancelUpdateSubsubcategoryName = function () {

            vm.SubsubcategoryNameStatus.Clear();

        }

        vm.updateSubsubcategoryName = function () {
            //Debug.trace("Updating subsubcategory name...");

            vm.SubsubcategoryNameStatus.Updating = true;
            vm.SubsubcategoryNameStatus.Editing = false;

            categoryServices.updateSubsubcategoryName(vm.subsubcategory.SubsubcategoryID, vm.SubsubcategoryNameStatus.NewSubsubcategoryName)
           .success(function (data, status, headers, config) {

               vm.SubsubcategoryNameStatus.Updating = false;
               vm.SubsubcategoryNameStatus.SendingComplete = true;

               if (data.isSuccess) {

                   vm.SubsubcategoryNameStatus.Results.IsSuccess = true;
                   vm.SubsubcategoryNameStatus.Results.Message = "Subsubcategory name has been changed.";

                   //Update SubsubcategoryName and SubsubcategoryNameKey 
                   vm.subsubcategory.SubsubcategoryName = vm.SubsubcategoryNameStatus.NewSubsubcategoryName;
                   vm.subsubcategory.SubsubcategoryNameKey = data.Results[0];
                   ...
                   vm.SubsubcategoryNameStatus.Results.IsSuccess = false;
                   vm.SubsubcategoryNameStatus.Results.Message = data.ErrorMessage;

               }

           }).error(function (data, status, headers, config) {

               vm.SubsubcategoryNameStatus.IsSuccess = false;
               vm.SubsubcategoryNameStatus.Results.Message = "An error has occurred while using the service.";
           })

        }

        vm.cancelSubsubcategoryNameEdit = function () {
        ...
        vm.editDescription = function () {
            ...
            vm.descriptionNewCopy = vm.subsubcategory.Description;
        ...
        vm.updateDescription = function () {
            ...
            categoryServices.updateSubsubcategoryDescription(vm.subsubcategory.SubsubcategoryID, vm.descriptionNewCopy)
           .success(function (data, status, headers, config) {
               ...
               if (data.isSuccess) {
                   ...
                   vm.subsubcategory.Description = vm.descriptionNewCopy;
        ...
        {
            vm.subsubcategory.Visible = null;

            categoryServices.updateSubsubcategoryVisibleState(vm.subsubcategory.SubsubcategoryID, true)
            .success(function (data, status, headers, config) {

                if (data.isSuccess) {
                    vm.subsubcategory.Visible = true;
                }
                else {
                    vm.subsubcategory.Visible = false;
                }
            })
                .error(function (data, status, headers, config) {
                    vm.subsubcategory.Visible = false;
        ...
        vm.makeHidden = function () {
            ...
            categoryServices.updateSubsubcategoryVisibleState(vm.subsubcategory.SubsubcategoryID, false)
            .success(function (data, status, headers, config) {
        ...
        vm.makeSubsubsubcategoryVisible = function (index) {

            vm.subsubcategory.Subsubsubcategories[index].Visible = null;

            categoryServices.updateSubsubsubcategoryVisibleState(vm.subsubcategory.Subsubsubcategories[index].SubsubsubcategoryID, true)
            .success(function (data, status, headers, config) {

                if (data.isSuccess) {
                    vm.subsubcategory.Subsubsubcategories[index].Visible = true;
                }
                else {
                    vm.subsubcategory.Subsubsubcategories[index].Visible = false;
                }
            })
                .error(function (data, status, headers, config) {
                    vm.subsubcategory.Subsubsubcategories[index].Visible = false;
        ...
        vm.makeSubsubsubcategoryHidden = function (index) {

            vm.subsubcategory.Subsubsubcategories[index].Visible = null;

            categoryServices.updateSubsubsubcategoryVisibleState(vm.subsubcategory.Subsubsubcategories[index].SubsubsubcategoryID, false)
            .success(function (data, status, headers, config) {
       ...
       ==========================================*/
        ...
        vm.startDeletion = function () {
            vm.subsubcategoryDeletion.Verify = true;
        }

        vm.cancelDeletion = function () {
            vm.subsubcategoryDeletion.reset();
        }

        vm.deleteSubsubcategory = function () {

            vm.subsubcategoryDeletion.Verify = false;
            vm.subsubcategoryDeletion.Processing = true;

            //Debug.trace("Deleting subsubcategory...");

            categoryServices.deleteSubsubcategory(vm.subsubcategory.SubsubcategoryID)
            .success(function (data, status, headers, config) {

                vm.subsubcategoryDeletion.Processing = false;
                vm.subsubcategoryDeletion.Complete = true;

                if (data.isSuccess) {

                    vm.subsubcategoryDeletion.IsSuccess = true;
                    vm.subsubcategoryDeletion.Message = "This subsubcategory has been deleted.";
                }
                else {

                    vm.subsubcategoryDeletion.IsSuccess = false;
                    vm.subsubcategoryDeletion.Message = data.ErrorMessage;
                }
                ...
                .error(function (data, status, headers, config) {
                    ...
                    vm.subsubcategoryDeletion.Processing = false;
                    vm.subsubcategoryDetailUpdates.IsSuccess = false;
                    vm.subsubcategoryDetailUpdates.Complete = true;
                    vm.subsubcategoryDetailUpdates.Message = "An error occurred while attempting to use the service...";
       ...
       ==========================================*/
        ...
        vm.imageObjectType = "subsubcategory"; //<-- Must update on different TYPES
        ...
        vm.getImageRecords = function () {
            ...
            vm.objectId = vm.subsubcategory.SubsubcategoryID;
       ...
       /*========================================
        ...
        function getSubsubcategory(chained) {
            //Debug.trace("Getting subsubcategory...");

            categoryServices.getSubsubcategory(vm.categoryAttribute, vm.subcategoryAttribute, vm.subsubcategoryAttribute)
            .success(function (data, status, headers, config) {

                vm.subsubcategory = data;
                //Debug.trace("Subsubcategory received!");
        ...
        function determineUI() {
            ...
            //if (vm.account.PaymentPlan.MaxSubsubsubcategories == 0)
            //{
                //vm.mainTabTitle = "Products";
            //}
            //else
            //{
            //if (vm.products.Results.length > 0 && vm.subsubcategory.Subsubsubcategories.length > 0) {
                    //vm.mainTabTitle = "Subsubsubcategories & Products";
                //}
                if (vm.subsubcategory.Subsubsubcategories.length > 0)
                {
                    vm.mainTabTitle = "Subsubsubcategories";
                }
       ...
       ==========================================*/
        ...
        vm.startOrdering = function (reorderTypeIn) {
            ...
            if (vm.reorderType == 'subsubsubcategories')
            {
                //Pipe in values and rename to generic items----------------
                for (var i = 0, len = vm.subsubcategory.Subsubsubcategories.length; i < len; ++i)
                {
                    var item = { ID: vm.subsubcategory.Subsubsubcategories[i].SubsubsubcategoryID, Name: vm.subsubcategory.Subsubsubcategories[i].SubsubsubcategoryName, Visible: vm.subsubcategory.Subsubsubcategories[i].Visible };
        ...
        vm.saveOrder = function () {
            ...
            if (vm.reorderType == 'subsubsubcategories') {
                ...
                if (vm.useAlphabeticalOrdering) {
                    ...
                    categoryServices.resetSubsubsubcategoryOrder(vm.subsubcategory.SubsubcategoryID)
                        .success(function (data, status, headers, config) {
                            vm.reorderProcessing = false;
                            if (data.isSuccess) {
                                vm.reorderProcessingSuccess = true;
                                getSubsubcategory(false);
                            }
                            else {
                    ...
                    categoryServices.reorderSubsubsubcategories(idList)
                        .success(function (data, status, headers, config) {
                            vm.reorderProcessing = false;
                            if (data.isSuccess) {
                                vm.reorderProcessingSuccess = true;
            ...
            if (vm.reorderType == 'products') {
                ...
                if (vm.useAlphabeticalOrdering) {
                    ...
                    productServices.resetProductOrder(vm.subsubcategory.FullyQualifiedName)
                        .success(function (data, status, headers, config) {
                            vm.reorderProcessing = false;
                            if (data.isSuccess) {
                                vm.reorderProcessingSuccess = true;
                    ...
                    productServices.reorderProducts(idList, vm.subsubcategory.FullyQualifiedName)
                        .success(function (data, status, headers, config) {
       ...
       ==========================================*/
        ...
        /* ==========================================
            ...
            Create Subsubsubcategory

        ==========================================*/

        vm.subsubsubcategoryConstraint = false; //<-- True if plan needs an upgrade

        vm.newSubsubsubcategory =
             {
                 Visible: true,
                 Name: null,
                 ...
                 Clear: function () {
                     //Debug.trace("Clearing new subsubsubcategory form data.");
        ...
        vm.newSubsubsubcategoryPath = null;
        vm.createSubsubsubcategory = function () {

            vm.subsubsubcategoryConstraint = false;
            vm.newSubsubsubcategory.IsSending = true;

            //Debug.trace("Creating subsubsubcategory...");

            categoryServices.createSubsubsubcategory(vm.subsubcategory.SubsubcategoryID, vm.newSubsubsubcategory.Name, vm.newSubsubsubcategory.Visible)
            .success(function (data, status, headers, config) {

                vm.newSubsubsubcategory.IsSending = false;
                vm.newSubsubsubcategory.SendingComplete = true;

                if (data.isSuccess) {

                    vm.newSubsubsubcategory.Results.IsSuccess = true;
                    vm.newSubsubsubcategory.Results.Message = "Created!";
                    vm.newSubsubsubcategoryPath = data.SuccessMessage;
                    getSubsubcategory(false);
                }
                else {
                    vm.newSubsubsubcategory.Results.IsSuccess = false;
                    vm.newSubsubsubcategory.Results.Message = data.ErrorMessage;

                    if (data.ErrorCode == "Constraint") {
                        vm.subsubsubcategoryConstraint = true;
                    }
                }
                ...
                .error(function (data, status, headers, config) {
                    ...
                    vm.newSubsubsubcategory.IsSending = false;
                    vm.newSubsubsubcategory.SendingComplete = true;
                    vm.newSubsubsubcategory.Results.Message = "An error occurred while attempting to use the service...";
                })
        }
       ...
       ==========================================*/
        ...
        function activate(){
            ...
            //Debug.trace('subsubcategoryIndexController activation complete');
