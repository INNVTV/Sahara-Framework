...
{
    [Authorize]
    public class DataInjectionController : Controller
    {
        ...
        // GET: /DataInjection/{id}
        //[Route("DataInjection/{id}")]
        ...
        [Route("DataInjection/Json/Get")]
        [HttpGet]
        public JsonNetResult GetDataInjection()
        {
            /*
        ...
        [Route("DataInjection/Json/Details/{id}")]
