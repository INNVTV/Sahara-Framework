...
namespace AccountAdminSite.ApplicationApiKeysService {
    ...
    public interface IApplicationApiKeysService {
        ...
        AccountAdminSite.ApplicationApiKeysService.ApiKeyModel[] GetApiKeys(string accountNameKey, string sharedClientKey);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IApplicationApiKeysService/GetApiKeys", ReplyAction="http://tempuri.org/IApplicationApiKeysService/GetApiKeysResponse")]
        System.Threading.Tasks.Task<AccountAdminSite.ApplicationApiKeysService.ApiKeyModel[]> GetApiKeysAsync(string accountNameKey, string sharedClientKey);
        ...
        string GenerateApiKey(string accountNameKey, string name, string description, string requesterId, AccountAdminSite.ApplicationApiKeysService.RequesterType requesterType, string sharedClientKey);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IApplicationApiKeysService/GenerateApiKey", ReplyAction="http://tempuri.org/IApplicationApiKeysService/GenerateApiKeyResponse")]
        System.Threading.Tasks.Task<string> GenerateApiKeyAsync(string accountNameKey, string name, string description, string requesterId, AccountAdminSite.ApplicationApiKeysService.RequesterType requesterType, string sharedClientKey);
        ...
        string RegenenerateApiKey(string accountNameKey, string apiKey, string requesterId, AccountAdminSite.ApplicationApiKeysService.RequesterType requesterType, string sharedClientKey);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IApplicationApiKeysService/RegenenerateApiKey", ReplyAction="http://tempuri.org/IApplicationApiKeysService/RegenenerateApiKeyResponse")]
        System.Threading.Tasks.Task<string> RegenenerateApiKeyAsync(string accountNameKey, string apiKey, string requesterId, AccountAdminSite.ApplicationApiKeysService.RequesterType requesterType, string sharedClientKey);
        ...
        AccountAdminSite.ApplicationApiKeysService.DataAccessResponseType DeleteApiKey(string accountNameKey, string apiKey, string requesterId, AccountAdminSite.ApplicationApiKeysService.RequesterType requesterType, string sharedClientKey);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IApplicationApiKeysService/DeleteApiKey", ReplyAction="http://tempuri.org/IApplicationApiKeysService/DeleteApiKeyResponse")]
        System.Threading.Tasks.Task<AccountAdminSite.ApplicationApiKeysService.DataAccessResponseType> DeleteApiKeyAsync(string accountNameKey, string apiKey, string requesterId, AccountAdminSite.ApplicationApiKeysService.RequesterType requesterType, string sharedClientKey);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IApplicationApiKeysServiceChannel : AccountAdminSite.ApplicationApiKeysService.IApplicationApiKeysService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ApplicationApiKeysServiceClient : System.ServiceModel.ClientBase<AccountAdminSite.ApplicationApiKeysService.IApplicationApiKeysService>, AccountAdminSite.ApplicationApiKeysService.IApplicationApiKeysService {
        ...
        public AccountAdminSite.ApplicationApiKeysService.ApiKeyModel[] GetApiKeys(string accountNameKey, string sharedClientKey) {
            return base.Channel.GetApiKeys(accountNameKey, sharedClientKey);
        }
        
        public System.Threading.Tasks.Task<AccountAdminSite.ApplicationApiKeysService.ApiKeyModel[]> GetApiKeysAsync(string accountNameKey, string sharedClientKey) {
        ...
        public System.Threading.Tasks.Task<string> GenerateApiKeyAsync(string accountNameKey, string name, string description, string requesterId, AccountAdminSite.ApplicationApiKeysService.RequesterType requesterType, string sharedClientKey) {
