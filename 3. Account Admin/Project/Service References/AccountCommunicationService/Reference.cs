...
namespace AccountAdminSite.AccountCommunicationService {
    ...
    public interface IAccountCommunicationService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAccountCommunicationService/GetAccountUserNotifications", ReplyAction="http://tempuri.org/IAccountCommunicationService/GetAccountUserNotificationsRespon" +
            "se")]
        AccountAdminSite.AccountCommunicationService.UserNotification[] GetAccountUserNotifications(AccountAdminSite.AccountCommunicationService.NotificationStatus notificationStatus, string userId, string sharedClientKey);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAccountCommunicationService/GetAccountUserNotifications", ReplyAction="http://tempuri.org/IAccountCommunicationService/GetAccountUserNotificationsRespon" +
            "se")]
        System.Threading.Tasks.Task<AccountAdminSite.AccountCommunicationService.UserNotification[]> GetAccountUserNotificationsAsync(AccountAdminSite.AccountCommunicationService.NotificationStatus notificationStatus, string userId, string sharedClientKey);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAccountCommunicationService/GetAccountUserNotificationsByType" +
            ...
            "Response")]
        AccountAdminSite.AccountCommunicationService.UserNotification[] GetAccountUserNotificationsByType(AccountAdminSite.AccountCommunicationService.NotificationType notificationType, AccountAdminSite.AccountCommunicationService.NotificationStatus notificationStatus, string userId, string sharedClientKey);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAccountCommunicationServiceChannel : AccountAdminSite.AccountCommunicationService.IAccountCommunicationService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AccountCommunicationServiceClient : System.ServiceModel.ClientBase<AccountAdminSite.AccountCommunicationService.IAccountCommunicationService>, AccountAdminSite.AccountCommunicationService.IAccountCommunicationService {
        ...
        public AccountAdminSite.AccountCommunicationService.UserNotification[] GetAccountUserNotifications(AccountAdminSite.AccountCommunicationService.NotificationStatus notificationStatus, string userId, string sharedClientKey) {
            return base.Channel.GetAccountUserNotifications(notificationStatus, userId, sharedClientKey);
        }
        
        public System.Threading.Tasks.Task<AccountAdminSite.AccountCommunicationService.UserNotification[]> GetAccountUserNotificationsAsync(AccountAdminSite.AccountCommunicationService.NotificationStatus notificationStatus, string userId, string sharedClientKey) {
