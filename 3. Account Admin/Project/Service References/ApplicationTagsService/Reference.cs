...
namespace AccountAdminSite.ApplicationTagsService {
    ...
    public interface IApplicationTagsService {
        ...
        AccountAdminSite.ApplicationTagsService.DataAccessResponseType CreateTag(string accountId, string tagName, string requesterId, AccountAdminSite.ApplicationTagsService.RequesterType requesterType, string sharedClientKey);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IApplicationTagsService/CreateTag", ReplyAction="http://tempuri.org/IApplicationTagsService/CreateTagResponse")]
        System.Threading.Tasks.Task<AccountAdminSite.ApplicationTagsService.DataAccessResponseType> CreateTagAsync(string accountId, string tagName, string requesterId, AccountAdminSite.ApplicationTagsService.RequesterType requesterType, string sharedClientKey);
        ...
        AccountAdminSite.ApplicationTagsService.DataAccessResponseType DeleteTag(string accountId, string tagName, string requesterId, AccountAdminSite.ApplicationTagsService.RequesterType requesterType, string sharedClientKey);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IApplicationTagsService/DeleteTag", ReplyAction="http://tempuri.org/IApplicationTagsService/DeleteTagResponse")]
        System.Threading.Tasks.Task<AccountAdminSite.ApplicationTagsService.DataAccessResponseType> DeleteTagAsync(string accountId, string tagName, string requesterId, AccountAdminSite.ApplicationTagsService.RequesterType requesterType, string sharedClientKey);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IApplicationTagsServiceChannel : AccountAdminSite.ApplicationTagsService.IApplicationTagsService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ApplicationTagsServiceClient : System.ServiceModel.ClientBase<AccountAdminSite.ApplicationTagsService.IApplicationTagsService>, AccountAdminSite.ApplicationTagsService.IApplicationTagsService {
        ...
        public AccountAdminSite.ApplicationTagsService.DataAccessResponseType CreateTag(string accountId, string tagName, string requesterId, AccountAdminSite.ApplicationTagsService.RequesterType requesterType, string sharedClientKey) {
            return base.Channel.CreateTag(accountId, tagName, requesterId, requesterType, sharedClientKey);
        }
        
        public System.Threading.Tasks.Task<AccountAdminSite.ApplicationTagsService.DataAccessResponseType> CreateTagAsync(string accountId, string tagName, string requesterId, AccountAdminSite.ApplicationTagsService.RequesterType requesterType, string sharedClientKey) {
        ...
        public AccountAdminSite.ApplicationTagsService.DataAccessResponseType DeleteTag(string accountId, string tagName, string requesterId, AccountAdminSite.ApplicationTagsService.RequesterType requesterType, string sharedClientKey) {
            return base.Channel.DeleteTag(accountId, tagName, requesterId, requesterType, sharedClientKey);
        }
        
        public System.Threading.Tasks.Task<AccountAdminSite.ApplicationTagsService.DataAccessResponseType> DeleteTagAsync(string accountId, string tagName, string requesterId, AccountAdminSite.ApplicationTagsService.RequesterType requesterType, string sharedClientKey) {
