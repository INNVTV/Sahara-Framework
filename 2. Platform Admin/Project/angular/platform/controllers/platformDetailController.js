(function () {
    ...
    var controllerId = 'platformDetailController';

    // TODO: replace app with your module name
    angular.module('app')
        .controller(controllerId,
        [
            'platformDetailServices',
            'platformDetailModels',
            'sharedServices',
           '$routeParams',
            platformDetailController
        ]);

    function platformDetailController(platformDetailServices, platformDetailModels, sharedServices, $routeParams) {
        ...
        vm.title = 'platformDetailController';
       ...
       ==========================================*/
        ...
        function activate() {
            ...
            Debug.trace('platformDetailController activation complete');
