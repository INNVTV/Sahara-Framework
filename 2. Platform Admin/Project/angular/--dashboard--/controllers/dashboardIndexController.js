(function () {
    ...
    function dashboardIndexController(dashboardIndexServices, dashboardIndexModels, sharedServices) {
       ...
       ==========================================*/
        ...
        vm.getData = function () {
            ...
            dashboardIndexServices.getData(id)
        ...
        vm.updateObject = function () {
            ...
            dashboardIndexServices.updateObject(id)
            .success(function (data, status, headers, config) {
