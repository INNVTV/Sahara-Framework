(function () {
    ...
    var controllerId = 'billingDetailController';

    // TODO: replace app with your module name
    angular.module('app')
        .controller(controllerId,
        [
            'billingDetailServices',
            'billingDetailModels',
            'sharedServices',
           '$routeParams',
    ...
    function billingDetailController(billingDetailServices, billingDetailModels, sharedServices, $routeParams) {
        ...
        vm.title = 'billingDetailController';
       ...
       ==========================================*/
        ...
        function activate() {
            ...
            Debug.trace('BillingDetailController activation complete');
